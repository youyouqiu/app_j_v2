...
import {copyMult, qCoderDataApi, qCoderDataApi_followUp} from "../../../../services/report";
...
const FollowUp = (props: any) => {
    ...
    const onOk = async () => {
        ...
        const reportInfo = {
            ...
            expectedBeltTime:QRData.expectedBeltTime
        };
    ...
    const onClose = async () => {
        const response = await copyMult({reportIds: [QRData.reportId]});
