    ...
    render() {
        ...
        return (
            <BaseContainer
                ...
                bodyStyle={{padding: 0}}
                rightView={showDel && !pureWechat ? rightView : null}>
                {isListCus ? (
                    <ScrollableTabView
                        locked={true}
                        initialPage={0}
                        ...
                        <CustomInfo data-value={{name: '客户信息'}} navigation={this.props.navigation}/>
                        <WechatInfo data-value={{name: '微信动态'}} navigation={this.props.navigation}/>
                    </ScrollableTabView>
                ) : null}
