...
import SignDetailSkeleton from "@/components/skeleton/components/SignDetailSkeleton";
...
class SingDetail extends Component {
    ...
    render() {
        let {visible, baseInfo, detailInfo, zhuData = {}} = this.state;
        ...
        return (
            <BaseContainer title='签约单详情' bodyStyle={{padding: 0, backgroundColor: '#F8F8F8'}}>
