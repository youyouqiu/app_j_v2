...
class Calculate extends PureComponent <propsTypes & NavigationScreenProps> {
    constructor(props: any) {
        super(props);
        this.state.commercialTotal = props.navigation.state.params?.commercialTotal?.toString() ?? '';
    }
    DEFAULT_LPR = 4.85;
    state = {
        show: false,
    ...
    _onChangeTab = (e: ChangeTabProperties) => {
    ...
    _getFormItem = (curr: keyLabelParam, loan_key: number) => {
        ...
        return <View data-value={{name: curr.label}} style={{flex: 1}}>
