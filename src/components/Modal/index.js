...
export default class BasicModal extends Component {
    ...
    basicContent = () =>{
        let {title,onClose,width,height,footerType = 'two',
            cancelText,confirmText,onOk, contentStyle = {},cancelBtnStyle = {}, closable, onClosable, cancelTextStyle
        } = this.props
                                ...
                                :footerType === 'two'?
                                    <View style={modalStyles.row}>
                                        <TouchableOpacity style={modalStyles.footerCancel} activeOpacity={0.8} onPress={onClose}>
                                            <Text style={[modalStyles.cancelText, cancelTextStyle]}>{cancelText || '取消'}</Text>
                                        </TouchableOpacity>
                                        <TouchableOpacity
    ...
    selectContent = () =>{
        ...
        return(
            <View style={[modalStyles.modalBg, {
                ...
                {/*,{height:scaleSize(height)}*/}
                <View style={[modalStyles.selectWrap,contentStyle]}>
                    {
                        title
                        ?
                        (typeof title === 'string'
